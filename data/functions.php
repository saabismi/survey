...
#<input type=\"submit\" value=\"Submit\"> value=\"$rivi['vve_id']\">
     
    print "</div>
    "; #kortti loppuu
/*
    $lahvastaaja = $_POST["vastaaja"];
    $lahvastaaja_email = $_POST["vastaaja_email"];
    $lahkys_id = $idkys;
    $lahvve_id = $_POST["2"];

/*
    $tietokantaan = "INSERT INTO vastaus (vastaaja, vastaaja_email, kys_id, vve_id) VALUES ('$lahvastaaja', '$lahvastaaja_email', '$lahkys_id', '$lahvve_id');";*/
